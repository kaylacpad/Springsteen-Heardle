...
function Nt(t) {
  ...
  return {
    c() {
      ...
      n.innerHTML = `
        <p class="mb-3">
          A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> but for Springsteen songs. Each song is randomly chosen from his entire discography, including special live versions, B-sides, and outtakes. Please refresh your browser (even if you are in between attempts) if your song guess does not populate.
        </p>
        <p class="mb-3">
          Made by <a href="https://twitter.com/kaylacp_">@kaylacp_</a>. All copyright goes to Springsteen, Columbia Records, and other relevant parties.
        </p>
        <p class="mb-3"></p>
        <p class="text-xs mb-3 text-custom-line">
          Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>. Powered by <a href="https://netlify.com/">Netlify</a>.
        </p>`;
      M(n, "class", "text");
    },
    m(e, t) {
  ...
  function It(t) {
    ...
    return {
      c() {
        ...
        (r = w("a")),
        (r.innerHTML =
          '<span class="kofitext svelte-1d3p4dy"><img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="Ko-fi donations" class="kofiimg mr-2 mb-1 svelte-1d3p4dy"/>Support the creator of this Heardle!</span><svg xmlns="http://www.w3.org/2000/svg" class="ml-2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7"></path></svg>'),
        M(
            r,
            "class",
            "kofi-button py-2 px-3 rounded-lg items-center flex  svelte-1d3p4dy"
          ),
          M(r, "href", "https://www.buymeacoffee.com/kaylacp"),
          M(r, "title", "Support the creator of this Heardle!"),
          M(
            n,
            "class",
    ...
    return (
      ...
      (u = new Bt({})), {
        c() {
          ...
          (s = w("p")),
          (n.innerHTML =
            "If you like this game, please consider supporting the Heardle creator."),
          (r = x()),
          (s = w("p")),
          (i = x()),
          (o = w("div")),
      ...
      (O = new Rt({})), {
        c() {
          ...
          W.c(),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Springsteen song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's Springsteen Heardle within the first ")),
        (n = _(s)),
        (r = _(" second(s)."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's Springsteen Heardle within ")),
        (n = _(o)),
        (r = _("\n                second.              Follow @RockHeardles on Twitter for updates regarding the Heardle")),
        (s = _(a)),
        (i = _("!"));
      },
      m(e, o) {
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's Springsteen Heardle. Better luck tomorrow! (Please clear your browser history if your results are populating before playing!)");
      },
      m(e, t) {
        g(e, n, t);
      },
      ...
      subscribe: ue(
        [{
          ...
          },
          {
            ...
            answer: "Bruce Springsteen - Stand on It",
          },
          {
          ...
          },
          {
            ...
            answer: "Bruce Springsteen - Somewhere North of Nashville",
          },
          {
          ...
          },
          {
            ...
            answer: "Bruce Springsteen - Shut Out the Light",
          },
          {
